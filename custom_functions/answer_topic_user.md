``` mysql
CREATE DEFINER=`root`@`localhost` FUNCTION `answer_topic_user`(`art_id` varchar(255), `tpc_id` varchar(255), `u_id` varchar(255), `header` varchar(255), `type` varchar(255), `content_url` varchar(255)) RETURNS int
BEGIN
	...
	if _err = 1 then
		...
		values (art_id, tpc_id, "topic", u_id, u_name, u_avatar, "normal", type, header, content_url, NOW());
